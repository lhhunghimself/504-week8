...
class MainWindow(QMainWindow):
    ...
    def _create_qpaint_canvas(self) -> MazeCanvas:
        """Create a MazeCanvas backed by the QPainter pre-rendered renderer.

        The backend creates its own QPaintViewport inside start(), which is
        called lazily from _ensure_qpaint_started() once the host is shown.
        """
